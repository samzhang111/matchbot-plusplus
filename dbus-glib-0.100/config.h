...
#define PACKAGE_STRING "dbus-glib 0.100"
...
#define PACKAGE_VERSION "0.100"

/* Define to 1 if you have the ANSI C header files. */
#define STDC_HEADERS 1

/* Full path to test file test/core/test-service-glib in builddir */
#define TEST_CORE_SERVICE_BINARY "/home/sam/code/matchbot/dbus-glib-0.100/test/core/test-service-glib"

/* Full path to test file test/test-exit in builddir */
#define TEST_EXIT_BINARY "/home/sam/code/matchbot/dbus-glib-0.100/test/test-exit"

/* Full path to test file test/interfaces/test-service in builddir */
#define TEST_INTERFACES_SERVICE_BINARY "/home/sam/code/matchbot/dbus-glib-0.100/test/interfaces/test-service"

/* Full path to test file test/test-segfault in builddir */
#define TEST_SEGFAULT_BINARY "/home/sam/code/matchbot/dbus-glib-0.100/test/test-segfault"

/* Full path to test file test/test-service in builddir */
#define TEST_SERVICE_BINARY "/home/sam/code/matchbot/dbus-glib-0.100/test/test-service"

/* Full path to test file test/data/valid-service-files in builddir */
#define TEST_SERVICE_DIR "/home/sam/code/matchbot/dbus-glib-0.100/test/data/valid-service-files"

/* Full path to test file test/test-shell-service in builddir */
#define TEST_SHELL_SERVICE_BINARY "/home/sam/code/matchbot/dbus-glib-0.100/test/test-shell-service"

/* Full path to test file test/test-sleep-forever in builddir */
#define TEST_SLEEP_FOREVER_BINARY "/home/sam/code/matchbot/dbus-glib-0.100/test/test-sleep-forever"
